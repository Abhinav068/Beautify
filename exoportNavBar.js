export const navbar =()=>{
    return ` <div id="top">
        <div id="head">
            <h3 id="beauty">BEAUTY BONANZA Get Your Daily Dose Of Amazing Deals</h3>
            <div class="icons">
        ...
        <div class="nav_category">
            <div class="category">
                <p><span><a href="navbar.html"><img src="logo.png" width="100px" height="30px"></a></span></p>
                <p>Categories</p>
                <p>Brand</p>
                <p>Luxe</p>
                <p>Beautify Fashion</p>
                <p>Beauty Advise</p>
                <div class="search">
                    <form id="nykaa_search">
                    <span class="material-symbols-outlined">search</span> 
                        <input type="text" placeholder="Search on Nykaa" style="height: 30px;margin-left:0px;border: none;  background-color:  #f4f4f4;">
                    </form>
                </div>
...
export const dropmenu = ()=>{
    return `<div class="dropdown_cat">
    <div class="drop_Makeup">
        <ul>
            <li><a href="#">Makeup</a>
                <div class="sub_menu">
                    <ul class= "list_cat">
                    ...
                    <ul class= "list_cat">
                        ...
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Makeup Kits & Combos</b></a></li>
                        <li><a>Makeup Kits</a></li>
                        <li><a>Makeup Combos</a></li>
                    </ul>
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Lips</b></a></li>
                        <li><a>Lipstic</a></li>
                        ...
                        <li><a>Lip Stain</a></li>
                        <br>
                        <li><a style="color:  rgb(46, 45, 45);"><b>Nails</b></a></li>
                    ...
                    <ul class= "list_cat">
                        ...
                        <br>
                        <li><a style="color:  rgb(46, 45, 45);"><b>Multi-Functional Makeup Palettes</b></a></li>
                    </ul>
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Top Brands</b></a></li>
                    ...
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Quick Links</b></a></li>
                        ...
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Trending Searches</b></a></li>
            ...
            <li><a href="#">Skin</a>
                <div class="sub_menu">
                <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Moisturizers</b></a></li>
                        ...
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Cleansers</b></a></li>
                        <li><a>Face Wash</a></li>
                        <li><a>Cleanser</a></li>
                    ...
                    <ul class= "list_cat">
                        ...
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Masks</b></a></li>
                        ...
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Toners</b></a></li>
                        <li><a>Toners & Mists</a></li>
                        <li><a>Rose Water</a></li>
                    </ul>
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Body Care</b></a></li>
                        ...
                        <br>
                        <li><a style="color:  rgb(46, 45, 45);"><b> Hands & Feet</b></a></li>
                        <li><a>Hand Creams</a></li>
                        <li><a>Foot Creams</a></li>
                        <li><a>Hand & Foot Masks</a></li>
                    </ul>
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Neck Creams</b></a></li>
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Specialised Skincare</b></a></li>
                        <li><a>Acne Spot Correctors</a></li>
                        <li><a>Nose Strips</a></li>
                        <li><a>Facial Peels</a></li>
                        <br>
                        <li><a style="color:  rgb(46, 45, 45);"><b>Eye Care</b></a></li>
                        ...
                        <li><a>Lip Masks</a></li>
                        <br>
                        <li><a style="color: rgb(46, 45, 45);"><b>Sun Care</b></a></li>
                    </ul>
                    <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Kits & Combos</b></a></li>
                        <li><a>Kay Beauty</a></li>
                        <li><a>Huda Beauty</a></li>
                        <li><a>Charlotte Tilbury</a></li>
                        <li><a>M.A.C</a></li>
            ...
            <li><a href="#">Hair</a>
                <div class="sub_menu">
                <ul class= "list_cat">
                        <li><a style="color: rgb(46, 45, 45);"><b>Face</b></a></li>
                        <li><a>Face Primer</a></li>
                        <li><a>Concealer</a></li>
                        <li><a>Foundation</a></li>
                        <li><a>Compact</a></li>
